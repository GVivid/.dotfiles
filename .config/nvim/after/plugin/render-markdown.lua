...
-- Sets the colors of the Rendered Headings
vim.api.nvim_set_hl(0, 'RenderMarkdownH1bg', {link = "markdownH1",default=true})
vim.api.nvim_set_hl(0, 'RenderMarkdownH2bg', {link = "markdownH2",default=true})
vim.api.nvim_set_hl(0, 'RenderMarkdownH3bg', {link = "markdownH3",default=true})
vim.api.nvim_set_hl(0, 'RenderMarkdownH4bg', {link = "markdownH4",default=true})
vim.api.nvim_set_hl(0, 'RenderMarkdownH5bg', {link = "markdownH5",default=true})
vim.api.nvim_set_hl(0, 'RenderMarkdownH6bg', {link = "markdownH6",default=true})

-- Sets the colors of the sign coloumn rendering
-- vim.api.nvim_set_hl(0, 'RenderMarkdownH1', {link = "markdownH1",default=true})
-- vim.api.nvim_set_hl(0, 'RenderMarkdownH2', {link = "markdownH2",default=true})
-- vim.api.nvim_set_hl(0, 'RenderMarkdownH3', {link = "markdownH3",default=true})
-- vim.api.nvim_set_hl(0, 'RenderMarkdownH4', {link = "markdownH4",default=true})
-- vim.api.nvim_set_hl(0, 'RenderMarkdownH5', {link = "markdownH5",default=true})
-- vim.api.nvim_set_hl(0, 'RenderMarkdownH6', {link = "markdownH6",default=true})
